 ...
 */
public class ListManageCouriersAdapter extends ArrayAdapter<Courier> {
    ...
    public ListManageCouriersAdapter(Context context, int textViewResourceId) {
        super(context, textViewResourceId);
    }

    public ListManageCouriersAdapter(Context context, int resource, List<Courier> items) {
